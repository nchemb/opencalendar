# OpenCalendar React drop-in

One file, no npm package. Copy `BookKit.tsx` into your app (e.g. `components/BookKit.tsx`)
and import from there.

```tsx
import { BookKitButton, BookKitInline, useBookKitEvent } from "@/components/OpenCalendar";
...
`baseUrl` is your OpenCalendar instance's URL. Every component lazy-loads `embed.js` from
